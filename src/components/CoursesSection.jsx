...
const CoursesSection = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="py-32 px-6 bg-gradient-to-b from-[#F37021]/5 via-white to-gray-100 overflow-hidden relative"
    ...
    >
      ...
      <motion.div className="absolute inset-0 pointer-events-none" style={{ y, opacity }}>
        ...
        <motion.div
          ...
          className="absolute top-1/2 left-1/2 w-[1200px] h-[1200px] -translate-x-1/2 -translate-y-1/2 border border-[#F37021]/10 rounded-full"
        />
      </motion.div>
...
>
        ...
        >
          <motion.div whileHover={{ scale: 1.05 }} className="inline-block mb-12">
            <a
              href="/enroll"
              className="group relative inline-flex items-center gap-4 px-12 py-6 bg-gradient-to-r from-[#F37021] to-red-600 text-white font-bold text-xl rounded-full overflow-hidden shadow-2xl hover:shadow-[#F37021]/50 transition-all duration-300"
            >
...
// === COURSE CARD (unchanged logic, only colors fixed) ===
const CourseCard = ({
    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          className={`absolute -top-5 left-1/2 -translate-x-1/2 bg-gradient-to-r ${badgeColor} text-white text-xs font-bold px-4 py-1.5 rounded-full shadow-xl flex items-center gap-1`}
        ...
        <motion.div
          ...
          style={{ transform: "translateZ(50px)" }}
        >
          <div className="p-5 bg-gradient-to-br from-[#F37021]/10 to-red-100 rounded-3xl shadow-inner">
        ...
        <motion.div className="flex items-center justify-center gap-2 text-[#F37021] font-semibold mb-4" style={{ transform: "translateZ(30px)" }}>
        ...
        <motion.div className="flex justify-between items-center text-sm" style={{ transform: "translateZ(30px)" }}>
          ...
          <motion.div whileHover={{ scale: 1.2 }} className="text-[#F37021] font-bold flex items-center gap-1">
