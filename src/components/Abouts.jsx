...
const AboutSection = () => {
  ...
  return (
    <section className="py-20 px-6 bg-gradient-to-b from-white via-[#F37021]/5 to-white">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-5xl md:text-6xl font-black bg-clip-text text-transparent bg-gradient-to-r from-[#F37021] to-red-600 mb-4">
            About Getfix Academy
          </h2>
          <p className="text-lg md:text-xl text-gray-700 max-w-4xl mx-auto leading-relaxed">
            Founded in 2019, we’re India’s <span className="font-bold text-[#F37021]">leading mobile repair training institute</span>.
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
          {stats.map((stat, i) => (
            <motion.div
              ...
              className="bg-white rounded-2xl p-6 shadow-lg border border-[#F37021]/20 text-center hover:shadow-xl transition-shadow"
            >
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          {missionVision.map((item, i) => (
            <motion.div
              ...
              className="bg-gradient-to-br from-[#F37021]/5 to-white p-8 rounded-3xl border border-[#F37021]/30 shadow-md hover:shadow-xl transition-all"
            >
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <h3 className="text-4xl md:text-5xl font-bold text-center mb-12 bg-clip-text text-transparent bg-gradient-to-r from-[#F37021] to-red-600">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {whyChoose.map((item, i) => (
              <motion.div
                ...
                className="group bg-white/90 backdrop-blur-sm rounded-2xl p-6 shadow-md border border-[#F37021]/20 hover:shadow-2xl transition-all duration-300"
              >
            ...
            {team.map((member, i) => (
              ...
              >
                <div className="h-64 relative">
                  <div className="absolute inset-0 bg-gradient-to-br from-[#F37021] to-red-600" />
                  <img
                    src={member.img}
                    alt={member.name}
        ...
        >
          <motion.a
            ...
            className="inline-flex items-center gap-4 px-10 py-5 bg-gradient-to-r from-[#F37021] to-red-600 text-white font-bold text-lg rounded-full shadow-2xl hover:shadow-[#F37021]/50 transition-all duration-300"
          >
